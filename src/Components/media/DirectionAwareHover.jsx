...
export const DirectionAwareHover = ({
  ...
  return (
    <motion.div
      ...
      ref={ref}
      className={cn(
        'md:h-96 w-full h-60 md:w-full bg-neutral-900 rounded-2xl overflow-hidden group/card relative',
        className
      )}
    >
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <motion.div
            ...
            className={cn('text-neutral-100 absolute bottom-4 left-4 z-40', childrenClassName)}
          >
            {children}
          </motion.div>
        </motion.div>
